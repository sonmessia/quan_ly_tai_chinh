...
class _RecordsScreenState extends State<RecordsScreen> with SingleTickerProviderStateMixin {
                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Column(
                        children: [
                          _buildSummaryCard('Income', incomeTotal, Colors.green),
                          const SizedBox(height: 8), // Khoảng cách giữa các card
                          _buildSummaryCard('Expense', expenseTotal, Colors.red),
                          const SizedBox(height: 8),
                          _buildSummaryCard('Balance', balance, Colors.deepPurple.shade700),
                        ],
                      ),
                    ],
                  ),
  ...
  Widget _buildSummaryCard(String label, double amount, Color color) {
    return Container(
      ...
      child: Row( // Đổi thành Row để label và amount nằm cùng hàng
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(
            label,
            ...
            onPressed: (_) {
              showDialog(
                ...
                builder: (_) => AlertDialog(
                  ...
                  title: Text('Delete Transaction', style: TextStyle(color: Colors.red.shade700)),
                  ...
                  actions: [
                    ...
                    TextButton(
                      onPressed: () {
                        Provider.of<TransactionProvider>(context, listen: false).deleteTransaction(t);
